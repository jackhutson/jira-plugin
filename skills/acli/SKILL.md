...
name: acli
description: >
  Use acli jira CLI for Jira work item management, project operations,
  sprint tracking, and board management with JQL search capabilities.
  Load this skill for ad-hoc Jira operations not covered by workflow skills,
  or when you need detailed ACLI command reference.
---
...
8. **Set custom fields at creation time** — they cannot be edited via acli
